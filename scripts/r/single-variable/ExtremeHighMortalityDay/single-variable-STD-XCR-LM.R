...
df <- df %>%
    filter(Days_Lag0 >= 0.061828 & Days_Lag0 < 0.887738)

cat("Fitting regression models...\n")
fit_df <- single_variable_binom(df = df, y = "ExtremeHighMortalityDay_Lag0", x_pos = c(14:22, 27, 29:1399), covariate = "Days_Lag0", int = FALSE, random_effect = "Site_Turn")
