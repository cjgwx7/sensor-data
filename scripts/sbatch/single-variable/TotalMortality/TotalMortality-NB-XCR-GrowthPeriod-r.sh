...
Rscript /group/deckerlab/cjgwx7/sensor-data/scripts/r/single-variable/TotalMortality/single-variable-NB-XCR-GrowthPeriod.R \
--data /group/deckerlab/cjgwx7/sensor-data/data/master/master-lagged-RUN=2023-01-12-21-07-38_MAXDATE=2022-07-20.csv \
--data-export /group/deckerlab/cjgwx7/sensor-data/results/single-variable/TotalMortality/TotalMortality-NB-XCR-GrowthPeriod-RUN=2023-01-12-21-07-38_MAXDATE=2022-07-20