...
fit_obj <- single_variable_negbin_ar1(df = df, y = "TotalMortality_Lag0", x_pos = c(18:ncol(df)), covariate = "GrowthPeriod", int = TRUE, random_effect = "Site_Room_Turn")
...
save(fit_obj, file = rdata_export)
cat("\n")
cat("\n")
