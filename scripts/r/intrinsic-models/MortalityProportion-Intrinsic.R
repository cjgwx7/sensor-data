...
print("Fit 1")
print("####################################################")
fit1 = glm(MortalityProportion ~ 1, # nolint
           family = binomial(),
           weights = Inventory,
...
print("Fit 2")
print("####################################################")
fit2 = glm(MortalityProportion ~ Days, # nolint
           family = binomial(),
           weights = Inventory,
           na.action = na.exclude,
           data = df)
...
print("Fit 3")
print("####################################################")
fit3 = glm(MortalityProportion ~ Days + I(Days^2), # nolint
           family = binomial(),
           weights = Inventory,
           na.action = na.exclude,
           data = df)
...
print("Fit 4")
print("####################################################")
fit4 = glm(MortalityProportion ~ Days + I(Days^2) + I(Days^3), # nolint
           family = binomial(),
           weights = Inventory,
           na.action = na.exclude,
           data = df)
...
print("Fit 5")
print("####################################################")
fit5 = glmer(MortalityProportion ~ (1 + Days|Site), # nolint
             family = binomial(),
             weights = Inventory,
             na.action = na.exclude,
             data = df)
...
print("Fit 6")
print("####################################################")
fit6 = glmer(MortalityProportion ~ (1 + Days + I(Days^2)|Site), # nolint
             family = binomial(),
             weights = Inventory,
             na.action = na.exclude,
             data = df)
...
print("Fit 7")
print("####################################################")
fit7 = glmer(MortalityProportion ~ (1 + Days + I(Days^2) + I(Days^3)|Site), # nolint
             family = binomial(),
             weights = Inventory,
             na.action = na.exclude,
             data = df)
...
print("Fit 8")
print("####################################################")
fit8 = glmer(MortalityProportion ~ (1 + Days|Site_Room_Turn), # nolint
             family = binomial(),
             weights = Inventory,
             na.action = na.exclude,
             data = df)
...
print("Fit 9")
print("####################################################")
fit9 = glmer(MortalityProportion ~ (1 + Days + I(Days^2)|Site_Room_Turn), # nolint
             family = binomial(),
             weights = Inventory,
             na.action = na.exclude,
             data = df)
...
print("Fit 10")
print("####################################################")
fit10 = glmer(MortalityProportion ~ (1 + Days + I(Days^2) + I(Days^3)|Site_Room_Turn), # nolint
             family = binomial(),
             weights = Inventory,
             na.action = na.exclude,
             data = df)
