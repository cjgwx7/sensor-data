...
# Date: 8/25/2022                                                             #
# Purpose: single variable logistic regression for high mortality             #
# days                                                                        #
#                                                                             #
###############################################################################
...
source("/group/deckerlab/cjgwx7/sensor-data/scripts/r/source/single_variable.R")
...
fit_df <- single_variable(df = master, y = "HighMortalityDay_Lag0", x_pos = c(14:26, 28:1399))
